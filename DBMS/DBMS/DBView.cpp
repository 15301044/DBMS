...
BEGIN_MESSAGE_MAP(CDBView, CTreeView)
	...
	ON_COMMAND(ID_32772, &CDBView::OnCrtDB)
	ON_COMMAND(ID_32778, &CDBView::OnOpenDB)
	ON_COMMAND(ID_32774, &CDBView::OnDeleteDB)
	ON_COMMAND(ID_32775, &CDBView::OnCrtTable)
	ON_COMMAND(ID_32779, &CDBView::OnLookTable)
	ON_COMMAND(ID_32787, &CDBView::OnConditionQuery)
	ON_NOTIFY_REFLECT(TVN_SELCHANGED, &CDBView::OnTvnSelchanged)
	ON_COMMAND(ID_32777, &CDBView::OnDeleteTable)
	ON_COMMAND(ID_32776, &CDBView::OnDesignTable)
	ON_COMMAND(ID_32773, &CDBView::OnRenameDB)
	ON_NOTIFY_REFLECT(TVN_BEGINLABELEDIT, &CDBView::OnTvnBeginlabeledit)
	ON_NOTIFY_REFLECT(TVN_ENDLABELEDIT, &CDBView::OnTvnEndlabeledit)
	ON_COMMAND(ID_32793, &CDBView::OnAddTable)
	ON_COMMAND(ID_32794, &CDBView::OnBackupDB)
